  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-center py-4">
        ...
        <h2 className="text-xl font-bold">RaFlow</h2>
        <p className="text-sm text-gray-500">实时语音输入工具</p>
      </div>
      ...
      {/* Features */}
      <div>
        <h3 className="text-sm font-medium mb-2">主要功能</h3>
      ...
      <div className="pt-4 border-t dark:border-gray-700">
        <h3 className="text-sm font-medium mb-2">相关链接</h3>
      ...
      {/* Credits */}
      <div className="pt-4 border-t dark:border-gray-700 text-center text-xs text-gray-500">
